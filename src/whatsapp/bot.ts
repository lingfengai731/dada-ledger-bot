...
const INTRO_MESSAGE = [
  ...
  '',
  "Invoice date is optional — I can read it from the receipt photo. But for weddings please *always* write *wed <date>* and *pic <name>*. If you skip them I'll try the schedule, but if you still see *???*, just tell me, then reply *ok*.",
  '',
  ...
  '   contoh: _15/6  wed 16/6  pic christi  1.000.000  putu  bunga mitir_',
  '',
  'Tanggal nota opsional — bisa saya baca dari foto nota. Tapi untuk wedding *selalu* tulis *wed <tanggal>* dan *pic <nama>*. Kalau lupa saya coba dari schedule, tapi kalau masih *???*, kasih tahu saya lalu balas *ok*.',
  '',
